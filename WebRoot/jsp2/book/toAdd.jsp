...
<title>Bootstrap Admin</title>
  ...
  <!--<![endif]-->
    ...
    <div class="span4 offset4 dialog">
        <div class="block">
            <div class="block-heading">添加书籍</div>
            <div class="block-body">
         <form id="tab" method="post" action="book_add.action">
		<label>书名</label><input type="text" name="book.name" >
...
<input type="text" name="book.price" >
 ...
 <label>作者</label>
  ...
  <input type="hidden" name="book.bookNum"  value="1">
  ...
  <label>出版日期</label>
	...
	<input   class="container"   type="text" name="book.pubDate" value="" id="demo-2">
