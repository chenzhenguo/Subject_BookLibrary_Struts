...
<html lang="en">
                ...
                <div class="sidebar-nav">
                  <div class="nav-header" data-toggle="collapse" data-target="#dashboard-menu">书籍管理</div>
                    <ul id="dashboard-menu" class="nav nav-list collapse in">
                        ...
                        <li class="active" >  <a href="category_list.action">图书分类管理</a></li>
                    </ul>
 ...
 <div class="span9">
	...
	<td>${bean.id }</td>
  	<td>${bean.name }</td>
				<td><a href="category_toUpdate.action?category.id=${bean.id }"><i class="icon-pencil"></i></a>					
	<a href="#myModal" onclick="deleteBook('${bean.id}');" role="button" data-toggle="modal"><i class="icon-remove"></i></a></td>
								</tr>
							</c:forEach>
...
<div class="modal small hide fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-header">
	    ...
	    <div class="modal-body">
	    	是否确定删除?
	    <form id="uploadForm" action="category_toUpdate.action" method="post">
			<input type="hidden" name="category.id " id="pid"/>
