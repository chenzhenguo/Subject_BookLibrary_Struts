    ...
    <div class="container-fluid">
        ...
        <div class="row-fluid">
         ...
         <li >   <a href="myBook_list.action">我的书包</a></li>
                ...
                <ul id="dashboard-menu" class="nav nav-list collapse in">
                 <li class="active" >  <a href="record_studentList.action?user.id=${user.id}">我的借书还书记录</a></li>
        ...
        <div class="span9">
   		...
   		<h1 class="page-title">${user.name }的借书记录</h1>
				...
				<div class="well">
					<table class="table">
						...
						<c:forEach items="${list }" var="bean">
							...
							<td>${bean.date }</td>
							<td>
							<c:if test="${bean.status ==1}" > 还书</c:if>
							<c:if test="${bean.status ==-1}" > 借书</c:if>
							</td>
							</tr>
							</c:forEach>
						</tbody>
